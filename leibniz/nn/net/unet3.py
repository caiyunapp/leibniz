...
class Transform(nn.Module):
    def __init__(self, in_channels, out_channels, nblks=10, block=None, relu=None, conv=nn.Conv2d):
        ...
        self.relu = relu
        self.block = block(self.out_channels, step=1.0 / nblks, ix=0, tx=nblks, relu=relu, conv=conv)
