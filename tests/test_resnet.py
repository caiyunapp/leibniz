...
class TestResNet(unittest.TestCase):
    ...
    def testHyp2D(self):
        ...
        net(th.rand(1, 1, 32, 16))
        net = resnet(1, 1, spatial=(32, 16), normalizor='instance', block=HyperBottleneck)
        net(th.rand(1, 1, 32, 16))
    ...
    def testHyp2D2(self):
        net = resnet(17, 1, factors=[-1, -1, -1, -1], vblks=[1, 1, 1, 1, 1], spatial=(32, 16), block=HyperBottleneck)
        net(th.rand(1, 17, 32, 16))
        net(th.rand(2, 17, 32, 16))
        net = resnet(119, 1, layers=5, ratio=0, factors=[-2, -1, -1, -1, -1], vblks=[1, 1, 1, 1, 1], spatial=(32, 16), block=HyperBottleneck)
    ...
    def testHyp3D(self):
        ...
        net(th.rand(1, 1, 4, 16, 32))
        net = resnet(1, 1, spatial=(4, 16, 32), normalizor='instance', block=HyperBottleneck)
        net(th.rand(1, 1, 4, 16, 32))
        net = resnet(1, 1, spatial=(4, 16, 32), normalizor='layer', block=HyperBottleneck)
        net(th.rand(1, 1, 4, 16, 32))
        net(th.rand(2, 1, 4, 16, 32))
